...
# No middleware or routers in emergency mode

@app.on_event("startup")
async def startup_event():
    """Emergency startup - no dependencies"""
    print("🚨 EMERGENCY MODE: Running minimal service")
    print("📦 Version: v3.5.40-emergency")
    print("⚠️  No database connections")
    print("⚠️  No external dependencies")
    print("✅ Service ready")
