...
TRANSLATIONS = {
    ...
    'hr': {  # Croatian
        ...
        # Dashboard
        'dashboard_weather': 'Vrijeme',
        'dashboard_chat': 'AVA Asistent',
        'dashboard_fields': 'Polja',
        'dashboard_messages': 'Poruke',
        'dashboard_welcome_chat': 'Dobrodošli u AVA!',
        'dashboard_chat_subtitle': 'Vaš poljoprivredni asistent je tu da vam pomogne',
        'dashboard_ask_placeholder': 'Pitajte AVA o vašoj farmi...',
        'dashboard_send': 'Pošalji',
        'dashboard_weather_unavailable': 'Vremenski podaci trenutno nisu dostupni',
        'dashboard_24h_forecast': '24-satna prognoza',
        'dashboard_5day_forecast': '5-dnevna prognoza',
        'dashboard_add_field': 'Dodaj polje',
        'dashboard_no_fields': 'Još nema dodanih polja',
        'dashboard_field_area': 'Površina',
        'dashboard_field_crop': 'Usjev',
        'dashboard_field_last_task': 'Zadnji zadatak',
        'dashboard_total_area': 'Ukupna površina',
        'dashboard_total_fields': 'Ukupno polja',
        'dashboard_tasks': 'Zadaci',
    ...
    'it': {  # Italian
        ...
        # Dashboard
        'dashboard_weather': 'Meteo',
        'dashboard_chat': 'Assistente AVA',
        'dashboard_fields': 'Campi',
        'dashboard_messages': 'Messaggi',
        'dashboard_welcome_chat': 'Benvenuto in AVA!',
        'dashboard_chat_subtitle': 'Il tuo assistente agricolo è qui per aiutarti',
        'dashboard_ask_placeholder': 'Chiedi ad AVA della tua fattoria...',
        'dashboard_send': 'Invia',
        'dashboard_weather_unavailable': 'Dati meteo temporaneamente non disponibili',
        'dashboard_24h_forecast': 'Previsioni 24 ore',
        'dashboard_5day_forecast': 'Previsioni 5 giorni',
        'dashboard_add_field': 'Aggiungi campo',
        'dashboard_no_fields': 'Nessun campo aggiunto ancora',
        'dashboard_field_area': 'Area',
        'dashboard_field_crop': 'Coltura',
        'dashboard_field_last_task': 'Ultimo lavoro',
        'dashboard_total_area': 'Area totale',
        'dashboard_total_fields': 'Campi totali',
        'dashboard_tasks': 'Attività',
