...
DEPLOYMENT_TIMESTAMP = '20250806220700'  # v4.17.8 - Add comprehensive debugging to crop update API
COMMIT_HASH = "debug-crop-update"  # Added detailed debug info to identify 500 errors in crop update
