...
DEPLOYMENT_TIMESTAMP = '20250809184500'  # v4.23.1 - Fix FAVA context loading with proper fallback
COMMIT_HASH = "fix-fava-context-loading"  # Fix FAVA not seeing farmer fields due to Redis connection issues
