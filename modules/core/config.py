...
DEPLOYMENT_TIMESTAMP = '20250727214500'  # v3.5.26 - CAVA Chat GPT-3.5 Integration Fix
COMMIT_HASH = "cava-gpt-fix"  # Fixed chat status + Added /chat/message endpoint + Real GPT integration
