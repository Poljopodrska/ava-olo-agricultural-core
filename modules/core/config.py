...
DEPLOYMENT_TIMESTAMP = '20250809194500'  # v4.23.4 - Add debug endpoint for Edi's data
COMMIT_HASH = "debug-edi-endpoint"  # Direct diagnostic endpoint to check Edi's fields and phone matching
