...
DEPLOYMENT_TIMESTAMP = '20250803154000'  # v4.0.7 - Rewrite basic auth middleware with enhanced debugging
COMMIT_HASH = "rewrite-auth-middleware"  # Complete rewrite of auth middleware with verbose logging
