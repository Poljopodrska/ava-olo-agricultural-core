...
DEPLOYMENT_TIMESTAMP = '20250803092000'  # v3.9.24 - Binary search step 10: single agronomic router
COMMIT_HASH = "test-agronomic"  # Testing only agronomic dashboard router
